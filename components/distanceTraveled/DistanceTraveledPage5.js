  ...
  return (
    <View style={{ flex: 1, width: "100%" }}>
      ...
      <View style={DistanceTraveledStyles.center_container}>
        <Text style={DistanceTraveledStyles.muted}>ALL TIME</Text>
        <Text style={[DistanceTraveledStyles.text, { fontSize: getDistFontSize(allTimeDist) }]}>{allTimeDistString}</Text>
      </View>
    </View>
  );
}
